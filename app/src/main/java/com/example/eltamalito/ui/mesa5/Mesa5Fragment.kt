...
import com.example.eltamalito.databinding.FragmentMesa5Binding
import com.example.eltamalito.ui.mesa5.Mesa5ViewModel
import java.text.DecimalFormat

class Mesa5Fragment : Fragment() {

    private var _binding: FragmentMesa5Binding? = null
    ...
    override fun onCreateView(
        ...
        val mesa5ViewModel =
            ViewModelProvider(this).get(Mesa5ViewModel::class.java)

        _binding = FragmentMesa5Binding.inflate(inflater, container, false)
        val root: View = binding.root

        val textView: TextView = binding.textMesa5
        mesa5ViewModel.text.observe(viewLifecycleOwner) {
            textView.text = it
        }
        val Mesaid = 5
        val bundle = Bundle()
...
//////////////////////////////////////////////////////////////////
        val tablamesa5 : TableLayout = binding.tablaMesa5
