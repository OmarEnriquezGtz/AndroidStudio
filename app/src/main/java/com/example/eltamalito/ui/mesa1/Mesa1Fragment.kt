...
import com.example.eltamalito.databinding.FragmentMesa1Binding
import java.text.DecimalFormat


class Mesa1Fragment : Fragment() {

    private var _binding: FragmentMesa1Binding? = null
    ...
    override fun onCreateView(
        ...
        val mesa1ViewModel =
            ViewModelProvider(this).get(Mesa1ViewModel::class.java)

        _binding = FragmentMesa1Binding.inflate(inflater, container, false)
        val root: View = binding.root

        val textView: TextView = binding.textMesa1
        mesa1ViewModel.text.observe(viewLifecycleOwner) {
            textView.text = it
        }
...
//////////////////////////////////////////////////////////////////
        val tablamesa1 : TableLayout = binding.tablaMesa1
...
/////////////////////////////////////////////////////
        ...
        total_text.setTypeface(Typeface.defaultFromStyle(BOLD),BOLD)
        ...
        if (total_cuenta.text as String > "0") {
            ...
            val p = menuBoton.layoutParams as MarginLayoutParams
            val sizeInDP = 50
...
////////////////////////
            ...
            total_cuenta.setTypeface(Typeface.defaultFromStyle(BOLD),BOLD)
