...
import com.example.eltamalito.databinding.FragmentMesa2Binding
import java.text.DecimalFormat

class Mesa2Fragment : Fragment() {

    private var _binding: FragmentMesa2Binding? = null
    ...
    override fun onCreateView(
        ...
        val mesa2ViewModel =
            ViewModelProvider(this).get(Mesa2ViewModel::class.java)

        _binding = FragmentMesa2Binding.inflate(inflater, container, false)
        val root: View = binding.root

        val textView: TextView = binding.textMesa2
        mesa2ViewModel.text.observe(viewLifecycleOwner) {
            textView.text = it
        }
        val Mesaid = 2
        val bundle = Bundle()
...
//////////////////////////////////////////////////////////////////
        val tablamesa2 : TableLayout = binding.tablaMesa2
