...
import com.example.eltamalito.databinding.FragmentMesa4Binding
import com.example.eltamalito.ui.mesa4.Mesa4ViewModel
import java.text.DecimalFormat

class Mesa4Fragment : Fragment() {

    private var _binding: FragmentMesa4Binding? = null
    ...
    override fun onCreateView(
        ...
        val mesa4ViewModel =
            ViewModelProvider(this).get(Mesa4ViewModel::class.java)

        _binding = FragmentMesa4Binding.inflate(inflater, container, false)
        val root: View = binding.root

        val textView: TextView = binding.textMesa4
        mesa4ViewModel.text.observe(viewLifecycleOwner) {
            textView.text = it
        }
        val Mesaid = 4
        val bundle = Bundle()
...
//////////////////////////////////////////////////////////////////
        val tablamesa4 : TableLayout = binding.tablaMesa4
