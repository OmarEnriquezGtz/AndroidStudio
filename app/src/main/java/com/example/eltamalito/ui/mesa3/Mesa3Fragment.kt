...
import com.example.eltamalito.databinding.FragmentMesa3Binding
import java.text.DecimalFormat

class Mesa3Fragment : Fragment() {

    private var _binding: FragmentMesa3Binding? = null
    ...
    override fun onCreateView(
        ...
        val mesa3ViewModel =
            ViewModelProvider(this).get(Mesa3ViewModel::class.java)

        _binding = FragmentMesa3Binding.inflate(inflater, container, false)
        val root: View = binding.root

        val textView: TextView = binding.textMesa3
        mesa3ViewModel.text.observe(viewLifecycleOwner) {
            textView.text = it
        }
...
//////////////////////////////////////////////////////////////////
        val tablamesa3 : TableLayout = binding.tablaMesa3
