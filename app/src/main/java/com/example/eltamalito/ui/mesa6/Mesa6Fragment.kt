...
import com.example.eltamalito.databinding.FragmentMesa6Binding
import com.example.eltamalito.ui.mesa6.Mesa6ViewModel
import java.text.DecimalFormat

class Mesa6Fragment : Fragment() {

    private var _binding: FragmentMesa6Binding? = null
    ...
    override fun onCreateView(
        ...
        val mesa6ViewModel =
            ViewModelProvider(this).get(Mesa6ViewModel::class.java)

        _binding = FragmentMesa6Binding.inflate(inflater, container, false)
        val root: View = binding.root

        val textView: TextView = binding.textMesa6
        mesa6ViewModel.text.observe(viewLifecycleOwner) {
            textView.text = it
        }
        val Mesaid = 6
        val bundle = Bundle()
...
//////////////////////////////////////////////////////////////////
        val tablamesa6 : TableLayout = binding.tablaMesa6
